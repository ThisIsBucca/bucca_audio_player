...
export default function BuccaMusicPlayer() {
        ...
        <div className="w-full max-w-sm mx-auto h-full flex flex-col">
          <div className="bg-black/40 backdrop-blur-lg rounded-2xl p-4 shadow-2xl border border-pink-500/20 flex-1 flex flex-col">
            ...
            <div className="relative z-10 flex-1 flex flex-col">
              ...
              {/* Error Display */}
              {audioError && (
                <div className="mb-3 p-2 bg-red-500/20 border border-red-500/30 rounded-xl flex items-center space-x-2">
  ...
  return (
    <div
      className="h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-4 flex items-center justify-center font-quicksand overflow-hidden"
      style={{
        backgroundImage: "url('/nightclub-bg.png')",
        backgroundSize: "cover",
        backgroundPosition: "center",
    ...
    >
      <div className="w-full max-w-6xl mx-auto h-full bg-black/40 backdrop-blur-lg rounded-2xl shadow-2xl border border-pink-500/20 overflow-hidden">
        {/* Dark overlay for better text readability */}
        <div className="absolute inset-0 bg-gradient-to-b from-black/60 to-black/40 rounded-2xl"></div>
        ...
        <div className="relative z-10 flex h-full">
          ...
          <div
            className={`w-80 bg-black/30 border-r border-pink-500/20 p-4 flex flex-col h-full ${
          ...
          >
            ...
            {currentPlaylist && (
              <div className="flex-1 flex flex-col min-h-0">
                ...
                <div
                  className="bg-black/20 backdrop-blur-sm rounded-xl border border-pink-500/20 p-3"
                  style={{ height: "400px" }}
                >
                  <div className="h-full overflow-y-scroll pr-1 custom-scrollbar">
          ...
          <div className="flex-1 p-4 flex flex-col min-w-0">
            ...
            {/* Error Display */}
            {audioError && (
              <div className="mb-4 p-2 bg-red-500/20 border border-red-500/30 rounded-xl flex items-center space-x-2">
                ...
                <>
                  {currentSong ? (
                    <div className="text-center mb-4 w-full">
                      <div className="w-32 h-32 bg-gradient-to-br from-pink-500/20 to-blue-500/20 rounded-full flex items-center justify-center mb-4 mx-auto border border-white/10 shadow-lg relative">
                        ...
                        >
                          <Heart
                            className={`h-4 w-4 ${currentSong.isFavorite ? "fill-pink-500 text-pink-500" : "text-white/60"}`}
                          />
                        </Button>
                      </div>
                      <h2 className="text-xl inline-block font-medium text-white mb-1 truncate max-w-md">{currentSong.name}</h2>
                  ...
                  {currentSong && (
                    <div className="w-full max-w-md mb-4">
                      <Visualizer audioRef={audioRef} isPlaying={isPlaying} type="bars" />
                    </div>
                  )}
                </>
              )}
            ...
            <div className="w-full max-w-2xl mx-auto">
              {/* Progress Bar */}
              <div className="space-y-2 bg-black/20 backdrop-blur-sm rounded-xl p-3 border border-pink-500/20 mb-4">
                <Slider
                  value={[currentTime]}
                  max={duration || 100}
                  step={1}
